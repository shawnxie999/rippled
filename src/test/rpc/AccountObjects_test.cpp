...
public:
    ...
    testObjectTypes()
    {
        ...
        }
        {
            ...
            auto const issuanceID = keylet::cftIssuance(alice.id(), env.seq(alice));
            ...
            jvCFToken[jss::CFTokenIssuanceID] = to_string(issuanceID.key);
            ...
            BEAST_EXPECT(cftoken[sfCFTokenIssuanceID.jsonName] == to_string(issuanceID.key));
        }
